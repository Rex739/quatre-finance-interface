...
const About = () => {
  return (
    <section className="wrapper font-inter text-lg lg:text-xl text-white1">
      <header className="text-left lg:text-center">
        <h2 className="font-nova-square text-[32px] lg:text-5xl xl:text-6xl mb-2">Who We Are</h2>
        ...
        <div className="flex flex-col lg:flex-row mt-10 items-center w-full">
          ...
          <div className="flex flex-col md:w-8/12 lg:w-5/12 text-left mr-auto  leading-[150%] lg:text-left lg:mx-auto">
            ...
            <p className="">
              At QuatreFinance, we harness the potentials of blockchain
              technology to provide solutions to existing  and emerging problem
              in societies making the solutions available globally.
            </p>
          </div>
        </div>
      </header>
